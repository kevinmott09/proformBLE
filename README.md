...
Seeed XIAO Esp32-C3 board interfacing with the lower control board of a Proform Le Tour de France exercise bike (Model#PFEX0118C.0).  There are indications that many Proform bikes use the same lower control board and MAY be compatible with this code.
...
ERG mode is now implemented but may be unstable as it is not extensively tested.
